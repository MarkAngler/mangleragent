...
describe("buildColumns", () => {
  ...
  it("groups by project, keeps runs newest-first, orders columns by most-recent run", () => {
    expect(buildColumns(runs, {})).toEqual([
